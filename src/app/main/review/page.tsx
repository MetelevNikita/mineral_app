...
const page: FC = () => {
    ...
    const needArr: needArrType[] = [
        {
            id: 1,
            title: 'Идеи по улучшению работы приложения'
        },
        {
            id: 2,
        ...
        {
            id: 4,
            title: 'Пожелания по работе приложения'
        },
        {
            id: 5,
        ...
        <Row>
            <Col className='d-flex justify-content-center align-items-center mb-4'>
                ...
                <div className={styles.review_container}>
                    ...
                    <div className={styles.review_container_text}>Мы искренне ценим каждого гостя нашего приложения и стремимся сделать ваше посещение максимально комфортным и интересным. Ваше мнение — это ключ к нашему развитию и совершенствованию.</div>
